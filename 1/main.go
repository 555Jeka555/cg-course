...
var (
	letterE = []float32{
		// Левый вертикальный столб (треугольники для закрашивания)
		-0.10, 0.10, 0, // Левый верхний угол
		-0.10, -0.10, 0, // Левый нижний угол
		-0.07, -0.10, 0, // Левый нижний угол (правая точка)

		-0.10, 0.10, 0, // Левый верхний угол
		-0.07, 0.10, 0, // Левый верхний угол (правая точка)
		-0.07, -0.10, 0, // Левый нижний угол (правая точка)

		// Верхняя горизонтальная линия
		-0.10, 0.10, 0, // Левый верхний угол
		0.10, 0.10, 0, // Правый верхний угол
		0.10, 0.06, 0, // Правый нижний угол

		-0.10, 0.10, 0, // Левый верхний угол
		0.10, 0.06, 0, // Правый нижний угол
		-0.10, 0.06, 0, // Левый нижний угол

		// Средняя горизонтальная линия (перемещаем её в центр)
		-0.10, 0.02, 0, // Левый верхний угол
		0.10, 0.02, 0, // Правый верхний угол
		0.10, -0.02, 0, // Правый нижний угол

		-0.10, 0.02, 0, // Левый верхний угол
		0.10, -0.02, 0, // Правый нижний угол
		-0.10, -0.02, 0, // Левый нижний угол

		// Нижняя горизонтальная линия
		-0.10, -0.10, 0, // Левый нижний угол
		0.10, -0.10, 0, // Правый нижний угол
		0.10, -0.06, 0, // Правый верхний угол

		-0.10, -0.10, 0, // Левый нижний угол
		0.10, -0.06, 0, // Правый верхний угол
		-0.10, -0.06, 0, // Левый верхний угол
	}
...
func draw(letters []Letter, window *glfw.Window, program uint32) {
	...
	for _, letter := range letters {
		...
		gl.DrawArrays(gl.TRIANGLES, 0, int32(len(letterE)/3))
	}
